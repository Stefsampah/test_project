#!/usr/bin/env ruby
# Script pour créer un script Ruby avec toutes les données JSON inline
...
script = <<~RUBY
  ...
  # Données JSON inline
  games_data = #{games_data.inspect}
  swipes_data = #{swipes_data.inspect}
  scores_data = #{scores_data.inspect}
  user_badges_data = #{user_badges_data.inspect}
  users_data = #{users_data.inspect}
...
File.write('import_inline.rb', script)
puts "✅ Script créé: import_inline.rb"
puts "   Taille: #{File.size('import_inline.rb') / 1024} KB"
