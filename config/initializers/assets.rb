...
Rails.application.config.assets.precompile += %w( controllers/reward_animation_controller.js )
Rails.application.config.assets.precompile += %w( controllers/swipe_controller.js )
Rails.application.config.assets.precompile += %w( controllers/youtube_modal_controller.js )
