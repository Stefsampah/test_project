#!/usr/bin/env ruby
# Script pour appliquer le système de badges amélioré (version corrigée)
# À exécuter avec: rails runner apply_improved_badge_system_fixed.rb
...
# 3. Supprimer les user_badges d'abord, puis les badges
puts "\n🗑️  Suppression des anciens user_badges et badges..."
old_user_badges_count = UserBadge.count
old_badge_count = Badge.count

# Supprimer d'abord les user_badges pour éviter les contraintes de clé étrangère
UserBadge.destroy_all
puts "✅ #{old_user_badges_count} user_badges supprimés"

# Maintenant on peut supprimer les badges
Badge.destroy_all
puts "✅ #{old_badge_count} badges supprimés"
