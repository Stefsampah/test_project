#!/usr/bin/env ruby
# Script simplifié pour importer les données sur Heroku
# Les fichiers JSON doivent être dans tmp/ sur Heroku
...
if missing_files.any?
  ...
  puts "💡 Copiez d'abord les fichiers JSON sur Heroku avec:"
  puts "   heroku run bash -a tubenplay-app"
  puts "   # Puis créez le dossier tmp/ et copiez les fichiers"
  exit 1
end
